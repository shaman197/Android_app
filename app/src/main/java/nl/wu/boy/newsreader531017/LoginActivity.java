...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void login(String mUsername, String mPassword) {
        retrofit.Callback<AuthToken> loginCallback = new Callback<AuthToken>() {
            @Override
            public void onResponse(Response<AuthToken> response) {
                showProgress(false);
                if (response.isSuccess() && response.body() != null) {
                    Globals.authToken = response.body().AuthToken;
                    Globals.resetList = true;
                    finish();
                }
        ...
        mService.login(user).enqueue(loginCallback);
    }
}
